...
function openCompetition(
    ...
    /*
     * Compétition payante :
     * confirmation puis ouverture
     * de WhatsApp avec message prérempli.
     */

    const confirmed =
        confirm(
            `Participation : ${formatNumber(fee)} ${competition.currency || "XOF"}\n\n` +
            `Voulez-vous contacter l'administrateur sur WhatsApp pour effectuer le paiement ?`
        );
    ...
    /*
     * Message automatiquement rempli
     */

    const message =
        `Bonjour, je souhaite participer à la compétition "${competition.title}".\n\n` +
        `Montant de participation : ${formatNumber(fee)} ${competition.currency || "XOF"}\n` +
        `Pseudo : ${username}\n` +
        `ID utilisateur : ${userId}\n\n` +
        `Je souhaite effectuer le paiement pour participer à cette compétition.`;
